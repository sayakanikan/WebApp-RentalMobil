<div class="main-content">
    ...
    <div class="alert alert-info" role="alert">
        Form hanya bisa disikan sekali. Mohon isi form dengan benar.
    </div>
        ...
        <form method="post" action="<?php echo base_url('admin/transaksi/transaksi_selesai_aksi') ?>">
            ...
            <div class="form-group">
                ...
                <select name="status_pengembalian" class="form-control">
                    <option value="<?php echo $tr->status_pengembalian?>" hidden><?php echo $tr->status_pengembalian?></option>
            ...
            <div class="form-group">
                ...
                <select name="status_rental" class="form-control">
                    <option value="<?php echo $tr->status_rental?>" hidden><?php echo $tr->status_rental?></option>
