...
<footer class="bg-light py-5">
    <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2021 - RentalMobil.com</div></div>
        ...
        <script>
            const cardTop = document.querySelectorAll(".card");

            cardTop.forEach((card, i) => {
                card.dataset.aos = "zoom-in";
                card.dataset.aosDelay = i * 20;
        ...
        <script type="text/javascript" src="<?php echo base_url('assets/') ?>vanilla-tilt.min.js"></script>
    </body>
</html>